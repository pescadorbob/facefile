...
1. User can open an edit view for an existing contact, pre-filled with the current name fields and photo
...
5. Submitting the edit form with the First Name cleared is rejected, and the contact is not changed
...
| 2 | S-2.6.2 | [User updates a contact's name](./stories/story-02-user-updates-a-contacts-name.md) | The most common correction (typo, learns a nickname) and the simplest edit to deliver. |
...
| 5 | S-2.6.5 | [Clearing the First Name blocks the update](./stories/story-05-clearing-the-first-name-blocks-the-update.md) | Validation boundary that protects stories 2–4 from producing an invalid contact. |
